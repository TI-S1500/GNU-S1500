...
/* 05/04/90 clm - new for COFF */
#ifdef ti1500
struct aux_entry 
{
  union auxent coff_auxent;
  struct aux_entry * aux_next; /* used to chain auxents together, */
			       /* if there ever happen to be two or more */
			       /* auxents for a symbol */
};

typedef struct aux_entry auxentS;
#endif

struct symbol			/* our version of an nlist node */
{
#ifdef ti1500
	struct syment coff_sy_nlist;
#endif
...
#ifdef ti1500
	struct aux_entry * sy_aux; /* a symbol table entry may have one or */
				   /*   more auxiliary entries */
#endif /* ti1500 */
};
...
#ifdef ti1500
#define coff_sy_name		coff_sy_nlist . _n . _n_nptr[1]
...
#ifdef ti1500
#define coff_sy_value	coff_sy_nlist.	n_value
